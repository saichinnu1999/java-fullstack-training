package com.capgemini.studentprofile.ui;
...
import com.capgemini.studentprofile.service.IStudentProfileService;
import com.capgemini.studentprofile.service.StudentProfileServiceImpl;

public class StudentProfileUI {

	public static Scanner scanner;
	
	public static IStudentProfileService service= new StudentProfileServiceImpl();
	...
	static void addStudent() {
	 ...
	 if(service.getStudentByRollNumber(student.getStudentRollNumber())!=null) {
		 System.err.println("Student on this roll no already exist");
	}
	 else {
